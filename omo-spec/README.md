...
│   ├── proposal/
│   │   ├── instruction.md                               # 从老 schema.yaml 提取
│   │   └── template.md                                  # 从老 templates/ 复制
│   ├── design/
│   │   ├── instruction.md
│   │   └── template.md
│   └── spec/
...
├── templates/
│   └── source-plan.md                                   # source plan 9 章节骨架模板
└── examples/
    └── add-user-auth/                                   # 端到端示例
```
...
│  │   ├─ 读 omo-spec/artifacts/<name>/instruction.md (只读)     │
│  │   ├─ 读 omo-spec/artifacts/<name>/template.md (只读)        │
...
- `instruction.md` — 行为约束(PHASE 1/2/3、Fast Fail Rule 等)
- `template.md` — 文件结构骨架
